...
//                qDebug()<< "QThread::sleep(1)";
            ...
            qDebug()<< "ConnectServer is ok";
            continue;
        }
        // qDebug()<< "recv data_size : " << data_size;
        for (int i = 0; i < data_size; i++)
        {
            buff_data += temp_buff[i];
        }
//        buff_data += std::string(temp_buff, 0, data_size);
